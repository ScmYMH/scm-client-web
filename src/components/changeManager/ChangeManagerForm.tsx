...
const ChangeManagerForm = () => {
	...
	const onClickConfrim = () => {
		...
		console.log('onClickConfirm --- cntrtIdArray.cntrtChangeInfoList : ', checkList);
	...
	useEffect(() => {
		setCheckList({ ...checkList, cntrtChangeInfoList: cntrtChangeInfoListData });
						...
						<tbody>
							{commonInfoListData?.map((commonInfo, index) => (
								<tr key={index}>
									...
									<td style={{ textAlign: 'right', paddingRight: 20, width: 150 }}>
						...
						<tbody>
							{cntrtChangeInfoListData?.map((cntrtChangeInfo, index) => (
								<tr key={index}>
									...
									<td style={{ paddingLeft: 20, width: 300 }}>{cntrtChangeInfo.cntrtNm}</td>
									<td style={{ paddingLeft: 20, width: 100 }}>{cntrtChangeInfo.preActorNm}</td>
									<td style={{ paddingLeft: 20, width: 100 }}>{cntrtChangeInfo.aftActorNm}</td>
									<td style={{ textAlign: 'right', paddingRight: 20, width: 150 }}>
									...
									<td style={{ paddingLeft: 20, width: 120 }}>{cntrtChangeInfo.cmptYn}</td>
									<td style={{ paddingLeft: 20 }}>{cntrtChangeInfo.reasonDesc}</td>
								</tr>
							))}
						</tbody>
					</Table>
