...
export const GET_CONTRACT_MEMBER_SUCCESS =
  "contractmember/GET_CONTRACT_MEMBER_SUCCESS";
export const GET_CONTRACT_MEMBER_ERROR =
  "contractmember/GET_CONTRACT_MEMBER_ERROR";
...
export const DELETE_CONTRACT_MEMBER_SUCCESS =
  "contractmember/DELETE_CONTRACT_MEMBER_SUCCESS";
export const DELETE_CONTRACT_MEMBER_ERROR =
  "contractmember/DELETE_CONTRACT_MEMBER_ERROR";
...
export const postUserMemberAsync = createAsyncAction(
  POST_USER_LIST,
